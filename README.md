# nvim-treesitter-queries-jinja_inline

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-jinja_inline/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-jinja_inline/actions/workflows/validate.yml)

Neovim tree-sitter queries for **jinja_inline**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-jinja_inline",
...
- [ ] Changes are scoped to `jinja_inline` — do not include files for other languages
